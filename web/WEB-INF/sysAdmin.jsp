<%-- 
    Document   : The system administrator page where a user whoes role is an administrator manages user's accounts.
                    ...
                    <form action="admin" method="POST">
                        ...
                        <div class="row mb-1">
                            ...
                            <select class="form-select" id="editFamily" name="editFamily"
                                ...
                                <c:forEach items="${families}" var="family">
                                    <option value="${family.familyId}"
                                            <c:if test="${editFamily == family.familyId}">selected</c:if>>
                                        ${family.familyName}
                                    </option>
                                </c:forEach>
                            </select>
